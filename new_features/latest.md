...
- 삼성전자는 2026 월드IT쇼에서 AI 포터블 프로젝터 신제품 '더 프리스타일+'와 TV AI 플랫폼 '비전 AI 컴패니언'을 공식 소개했습니다. 더 프리스타일+의 3D 오토 키스톤, 방해물 회피, 스크린 핏은 신규/강화 기능으로 확인됩니다.
- LG전자는 2026 월드IT쇼에서 무선 월페이퍼 OLED TV 오브제, OLED Theater, 3세대 알파11 AI 프로세서 업스케일링, LG 사운드 스위트, AI 홈 허브 '씽큐 온' 기반 홈 자동화 시나리오를 공식 소개했습니다. 신제품 출시라기보다 국내 전시/체험 공개 성격입니다.
- Amazon Japan은 Echo Dot NBA 공식 인증 에디션을 발표했습니다. 직접 TV 제품은 아니지만, 공식 보도자료가 Fire TV 시리즈와 Echo Dot 2대를 묶은 Alexa 홈시어터 구성을 명시해 간접 TV 인접 항목으로 분류했습니다.
...
- 분류: **직접 TV/디스플레이 관련**
- 핵심 내용:
  - 마이크로 RGB와 무안경 3D 디스플레이 '스페이셜 사이니지'를 전면 배치.
  - AI 포터블 프로젝터 신제품 '더 프리스타일+' 소개.
...
- 핵심 내용:
  - 무선 월페이퍼 OLED TV 'LG 시그니처 올레드 W' 25대로 구성한 초대형 오브제 전시.
  - '올레드 시어터'에서 OLED TV와 공간 맞춤 입체 음향 'LG 사운드 스위트' 소개.
...
- 핵심 내용:
  - NBA 및 5개 팀 로고 디자인의 Echo Dot 6종을 일본에서 판매/출하.
...
- 특허/논문/컨퍼런스/IR: 검색 구간 내 TV 신제품 또는 사용자 기능 발표로 직접 연결되는 고신뢰 신규 항목 확인 못함.
